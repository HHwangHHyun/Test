...
public class Utility {
	...
	public static String paging3(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		str.append(
				"  #paging A:hover{text-decoration:none; background-color: #fff000; color:#533d3f; font-size: 1em;}");
		...
		str.append("    border-color: #533d3f;");
		...
		str.append(" 	background-color: #fff000;");
